...
<div class="hero">
<h1>Embedded Electronics 101</h1>
<p>Three hands-on workshops. One ESP32 kit. From "I've never touched a wire" to a connected IoT dashboard you control from your phone.</p>
<div class="hero-cta">
<a href="0-pre-workshop/" class="md-button md-button--primary">Start with the pre-workshop</a>
<a href="https://github.com/zoharsf/embedded-electronics-101" class="md-button">View on GitHub</a>
</div>
</div>
